...
// Typography
import { obviaSans, obviaMono } from "@obvia/fonts"

// Styling
// import "@sirketio/interface/poox.css"
 ...
 * <Document bodyClass="dark">
 *   <Component />
 * </Document>
 *
 * // Root styling: applies "dark" class to <html>
 * <Document rootClass="dark">
 *   <Component />
 * </Document>
 * ```
 */
export default function Document({
  ...
  return (
    <html lang={language} dir={dir} className={cn(`${obviaSans.variable} ${obviaMono.variable}`, className)} suppressHydrationWarning={suppress}>
